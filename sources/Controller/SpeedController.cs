...
namespace K2D2.Controller
{
    public class VSpeedSettings
    {
        ...
        public SpeedController.Direction direction
         {
            get => Settings.s_settings_file.GetEnum<SpeedController.Direction>("speed.direction", 0);
            set {
                Settings.s_settings_file.SetEnum<SpeedController.Direction>("speed.direction", value);
                }
        }
    ...
    public class SpeedController : ComplexControler
    {
        public static SpeedController Instance { get; set; }

        public enum Direction { SurfaceUp, SurfaceSpeed }
        public static string[] direction_labels = {"V-Speed", "Brake" };
