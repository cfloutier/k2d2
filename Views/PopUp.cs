...
namespace K2D2
{
    public class PopUp
    {
        private Rect PopupRect { get; set; }
        ...
        public PopUp()
        {
            ...
            AddPopUpContents("Default", new Action(DefaultPopup));
            AddPopUpContents("Test", new Action(TestPopup));
        }
        ...
        {
            currentDisplayContent.DynamicInvoke();
        }
